...
RSpec.describe Election do
  ...
  describe '#candidates' do
    it 'returns an array of all candidate objects in election' do
      election = Election.new('2022')
      race1 = Race.new("Virginia District 4 Representative")
      race2 = Race.new("Texas Governor")
      election.add_race(race1)
  ...
  describe '#vote_counts' do
    it 'returns a hash showing how many votes each candidate recieved' do
      election = Election.new('2022')
      race1 = Race.new("Virginia District 4 Representative")
      race2 = Race.new("Texas Governor")
      election.add_race(race1)
  ...
  describe '#winners' do
    it 'returns an array of all candidates that have won their race' do
      election = Election.new('2022')
      race1 = Race.new("Virginia District 4 Representative")
      race2 = Race.new("Texas Governor")
      election.add_race(race1)
